...
public class Drivetrain extends SubsystemBase {
  public static final double kMaxVelocity = 2; // meters/second (m/s) //cannot go over 4.45
  public static final double kMaxVoltage = kMaxVelocity / (((473 / 6.75) * 0.1011 * Math.PI) / 60); /* THIS CANNOT GO OVER 12 VOLTS */
